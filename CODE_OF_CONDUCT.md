...
We as members, contributors, and leaders pledge to make participation in the gnhf community a harassment-free experience for everyone, regardless of age, body size, visible or invisible disability, ethnicity, sex characteristics, gender identity and expression, level of experience, education, socio-economic status, nationality, personal appearance, race, religion, or sexual identity and orientation.
...
Maintainers, listed in [`MAINTAINERS.md`](./MAINTAINERS.md), are responsible for clarifying and enforcing our standards of acceptable behaviour and will take appropriate and fair corrective action in response to any behaviour that they deem inappropriate, threatening, offensive, or harmful.
...
Instances of abusive, harassing, or otherwise unacceptable behaviour may be reported to the maintainers as described in [CONTRIBUTING.md → Code of conduct enforcement](./CONTRIBUTING.md#code-of-conduct-enforcement). All complaints will be reviewed and investigated promptly and fairly.
